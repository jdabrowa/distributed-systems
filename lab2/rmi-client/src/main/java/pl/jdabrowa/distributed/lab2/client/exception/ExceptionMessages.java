...
public class ExceptionMessages {
    public static final String INCORRECT_NUMBER_OF_ARGUMENTS = "Two arguments expected: nickname and game type (PLAYER or BOT)";
    public static final String NICK_MUST_NOT_BE_EMPTY = "First program argument (nickname) must not be empty";
